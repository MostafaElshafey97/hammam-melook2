                        ...
                        <div class="row">
                            <div class="col-md-10 col-lg-10 col-xl-9 mx-auto">
                                <div class="card-sigin">
                                    <div class="mb-5 d-flex"> <a href="{{ url('/' . $page='index') }}"><img src="{{URL::asset('Dashboard/img/brand/file-royal-crown-france-svg-wikimedia-commons-5.png')}}" class="sign-favicon ht-40" alt="logo"></a>&nbsp; &nbsp;<h1 class="main-logo1 ml-1 mr-0 my-auto tx-28">   حمام الملوك</h1></div>
                                    <div class="card-sigin">
                                        <div class="main-signup-header">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="sectionChooser">
                                                    ...
                                                    <option value="admin">تسجيل دخول المدير</option>
                                                    <option value="user">تسجيل دخول الرسيبشن</option>
                                            ...
                                            <h2>تسجيل دخول المدير </h2>
                                                <form method="POST" action="{{ route('login.admin') }}">
                                                    ...
                                                    </div><button type="submit" class="btn btn-main-primary btn-block">تسجيل الدحول</button>
