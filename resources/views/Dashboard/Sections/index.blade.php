...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الفروع</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{trans('Dashboard/main-sidebar_trans.view_all')}}</span>
						</div>
					</div>
				</div>
				<!-- breadcrumb -->
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table text-md-nowrap" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <th class="wd-15p border-bottom-0">عنوان الفرع</th>
                                                <th class="wd-20p border-bottom-0">الرقم الارضي</th>
                                                <th class="wd-20p border-bottom-0">رقم الموبايل</th>
                                                <th class="wd-20p border-bottom-0">رقم موبايل اخر</th>
                                           ...
                                           @foreach($sections as $section)
                                               <tr>
                                                   ...
                                                   <td>{{ \Str::limit($section->address, 100) }}</td>
                                                   <td>{{ $section->phone }}</td>
                                                   <td>{{ $section->mobile }}</td>
                                                   <td>{{ $section->mobile2 }}</td>
